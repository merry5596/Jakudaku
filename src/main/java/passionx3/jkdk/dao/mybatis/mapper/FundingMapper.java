...
public interface FundingMapper {
	...
	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID AS THEMEID, I.NAME AS NAME, I.UPLOADDATE AS UPLOADDATE, " + 
			...
			"WHERE I.approval = 0 AND I.ITEMID = F.ITEMID AND T.THEMEID = I.THEMEID AND A.USERID = I.USERID")
	...
	@Select("SELECT * FROM (SELECT i.itemId AS itemId, i.name, uploaddate, price, likenum, thumbnail1, isforsale, " + 
			...
			"AND i.isforsale = 1 AND FINISHDATE >= #{today} ORDER BY i.uploaddate DESC ) " + 
			"WHERE ROWNUM < 6")
	List<Funding> getNewFundingItemListforHome(@Param("today") String today);
  ...
  // 여기부터 조건 검색
	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			...
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND I.approval = 1 AND FINISHDATE >= #{today} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY UPLOADDATE DESC")
	List<Funding> getFundingItemListOrderByUploadDate(String keyword, String today);

	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			+ " I.THUMBNAIL1, I.THUMBNAIL2, I.THUMBNAIL3, I.ISFORSALE, I.DESCRIPTION, I.APPROVAL, TO_CHAR(F.FINISHDATE, 'YYYY/MM/DD HH24:MI:SS') AS FINISHDATE, F.PURCHASEQUANTITY, F.TARGETQUANTITY"
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND I.approval = 1 AND FINISHDATE >= #{today} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY LIKENUM DESC")
	List<Funding> getFundingItemListOrderByLikeNum(String keyword, String today);
   
	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			+ " I.THUMBNAIL1, I.THUMBNAIL2, I.THUMBNAIL3, I.ISFORSALE, I.DESCRIPTION, I.APPROVAL, TO_CHAR(F.FINISHDATE, 'YYYY/MM/DD HH24:MI:SS') AS FINISHDATE, F.PURCHASEQUANTITY, F.TARGETQUANTITY"
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND I.approval = 1 AND FINISHDATE >= #{today} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY FINISHDATE")
	List<Funding> getFundingItemListOrderByFinishDate(String keyword, String today);
  
	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			+ " I.THUMBNAIL1, I.THUMBNAIL2, I.THUMBNAIL3, I.ISFORSALE, I.DESCRIPTION, I.APPROVAL, TO_CHAR(F.FINISHDATE, 'YYYY/MM/DD HH24:MI:SS') AS FINISHDATE, F.PURCHASEQUANTITY, F.TARGETQUANTITY"
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND I.approval = 1 AND FINISHDATE >= #{today} AND I.THEMEID = #{themeId} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY UPLOADDATE DESC")
	List<Funding> getFundingItemListByThemeOrderByUploadDate(int themeId, String keyword, String today);

	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			+ " I.THUMBNAIL1, I.THUMBNAIL2, I.THUMBNAIL3, I.ISFORSALE, I.DESCRIPTION, I.APPROVAL, F.FINISHDATE, F.PURCHASEQUANTITY, F.TARGETQUANTITY"
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND FINISHDATE >= #{today} AND I.THEMEID = #{themeId} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY LIKENUM DESC")
	List<Funding> getFundingItemListByThemeOrderByLikeNum(int themeId, String keyword, String today);
	
	@Select("SELECT I.ITEMID, I.USERID AS PRODUCERID, A.ALIAS AS PRODUCERNAME, I.THEMEID, T.NAME AS THEMENAME, I.NAME, I.UPLOADDATE, I.PRICE, I.LIKENUM,"
			+ " I.THUMBNAIL1, I.THUMBNAIL2, I.THUMBNAIL3, I.ISFORSALE, I.DESCRIPTION, I.APPROVAL, F.FINISHDATE, F.PURCHASEQUANTITY, F.TARGETQUANTITY"
			+ " FROM ITEM I, FUNDINGITEM F, THEME T, ACCOUNT A"
			+ " WHERE I.ITEMID = F.ITEMID AND I.THEMEID = T.THEMEID AND I.USERID = A.USERID AND FINISHDATE >= #{today} AND I.THEMEID = #{themeId} AND i.name LIKE '%' ||  #{keyword} || '%' ORDER BY FINISHDATE")
	List<Funding> getFundingItemListByThemeOrderByFinishDate(int themeId, String keyword, String today);
